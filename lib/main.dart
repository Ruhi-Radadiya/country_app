    ...
    MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(backgroundColor: Colors.black87,
          title: const Text("COUNTRIES", style: TextStyle( color: Colors.white30,fontWeight: FontWeight.w600),),
          centerTitle: true,
        ),
        body: Center(
          child: RichText(
            text: const TextSpan(
                ...
                children: <TextSpan>[
                  ...
                  TextSpan(text:"MALAYSIA\n",style: TextStyle(color: Color(0xffE0F7FA),fontWeight: FontWeight.w400),),
                  ...
                  TextSpan(text:"RUSSIA\n",style: TextStyle(color: Colors.amber,fontWeight: FontWeight.w400),),
                  ...
                  TextSpan(text:"UNITED STATES\n",style: TextStyle(color: Color(0xffFFECB3),fontWeight: FontWeight.w400),),
                ]
            ),
          ),
        ),
